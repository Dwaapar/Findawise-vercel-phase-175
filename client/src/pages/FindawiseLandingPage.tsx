...
export default function FindawiseLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-mesh text-white overflow-x-hidden relative">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-slate-950/80 via-blue-950/60 to-purple-950/80" />
