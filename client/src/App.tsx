...
import AIBrainInjector from "@/pages/admin/AIBrainInjector";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/empire-dashboard" component={EmpireDashboard} />
      ...
      <Route path="/admin/ai-brain-injector" component={AIBrainInjector} />
      ...
      <Route path="/admin/empire-control" component={ComprehensiveAdminDashboard} />
